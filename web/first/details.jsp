				...
				<table class="table table-bordered">
					<tbody>
						...
						<tr>
							<td>固定电话</td>
							<td>${demandBean.GDDH }
							  <div id="dBphone" class="STYLE1" style="display: none"></div></td><td><span class="STYLE1">*</span>移动电话</td>
							  <td>${demandBean.YDDH }
						...
						<tr>
				    <td colspan="1"><span class="STYLE1">*</span>关键字<em>(至少填写一个关键字，逐个输入)</em>	<div id="dBgjz" class="STYLE1" style="display: none"></div>		</td>
